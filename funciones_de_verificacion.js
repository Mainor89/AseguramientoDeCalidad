...
function Es_numero(año){
		var contador; //contador que sirve para recorrer el arraglo y funciona como condicion para detener el clico for
		var largo_del_string = año.length; //es el largo del string "año" usado como condicion para detener el clico for
		...
		for (contador = 0; contador < largo_del_string ; contador++){
			...
			var caracter = año.charAt(contador); //esta variable almacena caracteres individuales del string
...
function validar_fecha(año,mes,dia){
	...
	if(!string_vacio(año)){
		...
		if(Es_numero(año)){
	      var valor_entero_año = parseInt(año);   //convierte a entero el string año
	      ...
	      if(comprobar_bisiesto(valor_entero_año)){
